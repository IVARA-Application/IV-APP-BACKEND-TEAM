...
class TeacherAcademicsPage extends StatefulWidget {
  static String id = 'TeacherAcademicsPage';
  const TeacherAcademicsPage({Key key}) : super(key: key);

  @override
  _TeacherAcademicsPageState createState() => _TeacherAcademicsPageState();
}

class _TeacherAcademicsPageState extends State<TeacherAcademicsPage> {
  int current = 0;
        ...
        child: DropdownButtonHideUnderline(
          child: DropdownButton<String>(
            ...
            hint: Padding(
              ...
              child: Text(
                dropdownList[0],
                style: TextStyle(color: blue, fontSize: screenHeight * 0.028),
              ),
            ),
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              makeDropDown(
                                  subject, screenWidth, screenHeight),
                              Padding(
                                padding:
