...
class PAttendancePage extends StatefulWidget {
  static String id = 'PAttendancePage';
  const PAttendancePage({Key key}) : super(key: key);
  @override
  _PAttendancePageState createState() => _PAttendancePageState();
}

class _PAttendancePageState extends State<PAttendancePage> {
  int currentday = 0;
